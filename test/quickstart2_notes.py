...
#print(slide)
## 
#dd=service.presentations().pages().getThumbnail(presentationId=PRESENTATION_ID, pageObjectId="gc4b19c1fbb_0_7", thumbnailProperties_thumbnailSize="LARGE")
#print(dir(dd))
#dd_exe=dd.execute()
#print(dict(dd_exe))
#urllib.request.urlretrieve(dd_exe["contentUrl"], "test.png")
